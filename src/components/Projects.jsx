...
function Projects() {
  return (
    <div className='flex-col gap-3 items-center justify-center align-middle'>
        <Textframe imgsrc={'/imgs/Github.svg'} title={"Album Art Extractor"} description={"Album art cover color palette extractor"} description2={["JavaScript", 'Vite', 'React', 'Node.js', 'Spotify API']} link={'https://github.com/emmanuel-jaimes/muse.git/'}/>
